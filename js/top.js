...
$(document).ready(function() {
    ...
    $('#slider01').on('beforeChange', function(event, slick, currentSlide, nextSlide) {
    	$('#slider01 .slick-slide:nth-child('+(nextSlide+1)+') img').addClass('zoom');
    });
   $('#slider01').on('afterChange', function(event, slick, currentSlide) {
    	...
    	$('#slider01 .slick-slide:nth-child('+number+') img').removeClass('zoom');
    });
});
...
/*===========box link==========*/
$(document).ready(function(e) {
	$(".box07_sub02,.box07_sub01 li:nth-child(1), .box07_sub01 li:nth-child(2) .box07_gray, .box08_sub, .box09_list li, .box12_list li, .box14_list li").click(function(){
